...
public class AccountTransfersReadPlatformServiceImpl implements
    ...
    private static final class AccountTransfersMapper implements
        ...
        public AccountTransfersMapper() {
            ...
            sqlBuilder.append("paymentdata.id as payment_detail_id,");
            sqlBuilder.append("paymentdata.account_number,");
            sqlBuilder.append("paymentdata.check_number,");
            sqlBuilder.append("paymentdata.receipt_number,");
            sqlBuilder.append("paymentdata.bank_number,");
            sqlBuilder.append("paymentdata.routing_code,");
            sqlBuilder.append("paymenttype.id as payment_type_id,");
            sqlBuilder.append("paymenttype.value as payment_type");
            ...
            sqlBuilder.append("left join m_payment_detail paymentdata on fromsavtran.payment_detail_id = paymentdata.id or fromloantran.payment_detail_id = paymentdata.id ");
            sqlBuilder.append("left join m_payment_type paymenttype on paymentdata.payment_type_id = paymenttype.id ");
        ...
        public AccountTransferData mapRow(final ResultSet rs,
            ...
            long paymentDetailId = rs.getLong("payment_detail_id");
            if(!rs.wasNull()) {
            	PaymentTypeData paymentTypeData = PaymentTypeData.instance(rs.getLong("payment_type_id"),
            			rs.getString("payment_type"));
				paymentDetailData = new PaymentDetailData(paymentDetailId, paymentTypeData,
						rs.getString("account_number"), rs.getString("check_number"), rs.getString("routing_code"),
						rs.getString("receipt_number"), rs.getString("bank_number"));
            }
            ...
            return AccountTransferData.instance(id, reversed, transferDate,
                    ...
                    fromAccount, toAccountType, toAccount, paymentDetailData);
        }
    }
